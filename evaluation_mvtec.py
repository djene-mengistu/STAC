...
def compare(start,step,TP,P,T,input_type,threshold,predict_folder, gt_folder, sal_folder, name_list, num_cls=2):
...
def do_python_eval(predict_folder, gt_folder, sal_folder, name_list, num_cls=2, input_type='png', threshold=1.0, printlog=False):
    TP = []
    P = []
    T = []
    for i in range(num_cls):
