# -*- coding: utf-8 -*-
"""
The implementation is borrowed from: S. Liu, S. Zhi, E. Johns, and A. J. Davison, “Bootstrapping Semantic
Segmentation with Regional Contrast,” in ICLR 2022, 2022, p. 17
"""
...
# Define ReCo loss
# --------------------------------------------------------------------------------
def compute_pico_loss(rep, label, mask, prob, strong_threshold=0.6, temp=0.4, num_queries=200, num_negatives=200):
