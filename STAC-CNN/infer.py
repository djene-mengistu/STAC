...
# from model_new_sal import deit_small_MCTformerPlus
...
def parse_args():
    ...
    parser.add_argument("--crf_t", default=(5,10), type=int)
    parser.add_argument("--cam_npy", default="C:/Users/djmen/Desktop/EPS_mod/result/cam_npy_eps_0.5", type=str)
    parser.add_argument("--cam_png", default="C:/Users/djmen/Desktop/EPS_mod/result/cam_png_eps_0.5", type=str)
...
def infer_cam_mp(process_id, image_ids, label_list, cur_gpu):
    ...
    for i, (img_id, label) in enumerate(zip(image_ids, label_list)):
        ...
        if args.network_type == 'cls':
            ...
            cam_np = np.array(cam_list, dtype="object") #dtype = 'object' is added because it returned non-homogenous
            cam_fg = cam_np[:, 0]
